...
def load_from_zoo(model, model_name, pretrained_path='/usr/local/data/guopeng/PointNu-Net-main/pretrained/official'):
    ...
    load_npy(model, load_npy_from_url(url=model_urls[model_name], file_name=file_name)) #load_npy_from_url(url=model_urls[model_name], file_name=file_name)
