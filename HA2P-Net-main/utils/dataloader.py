...
class NucleiDataset(data.Dataset):
    ...
    def load_crop_data(self, img_paths, gt_paths, patch_size=384, stride=128): ##kuamr stride = 128
        out_imgs = []
        out_masks = []
        out_labels = []
...
class PannukeDataset(data.Dataset):
    ...
    def load_pannuke(self, data_root,fold=1):
        ...
        # print(f'processed data with size {out_imgs.shape[0]}')
