...
def main(args):
    ...
    save_path = '/usr/local/data/guopeng/PointNu-Net-main/pannuke_outputs'
    if not os.path.exists(save_path):
        os.mkdir(save_path)

    true_path = os.path.join('datasets/PanNuKe/masks/fold3','masks.npy')  # path to the GT for a specific split
    pred_path = os.path.join('outputs/pannuke_experiment/train_2_to_test_3', 'masks.npy')  # path to the predictions for a specific split
    types_path = os.path.join('datasets/PanNuKe/images/fold3','types.npy') # path to the nuclei types
