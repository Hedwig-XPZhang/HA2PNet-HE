...
if __name__ == "__main__":
    ...
    parser.add_argument("--pred_dir", help="point to output dir", default="myExperiments_pred/consep/exp_6/" )
    parser.add_argument("--true_dir", help="point to ground truth dir", default="datasets/CoNSeP/test/Labels/")
