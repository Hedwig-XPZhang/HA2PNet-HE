...
parser.add_argument('--save_path', type=str, default='outPuts_result/pannuke')
...
def main():
    ...
    pred_p = rf'myExperiments/Pannuke/{opts.name}/train_{opts.train_fold}_to_test_{opts.test_fold}'
